        ...
        <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
            ...
            <div className="w-full md:w-[67% lg:w-[40%] lg:ml-20" >
                <form >
                    ...
                    <button className="w-full bg-blue-600 text-white px-7 py-2 text-sm uppercase rounded font-medium shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800" >Sign in</button>
